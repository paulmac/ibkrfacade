...
public class OrderSamples {
	...
	public static Order PeggedToStock(String action, double quantity, double delta, double stockReferencePrice,
	...
	// Forex orders can be placed in denomination of second currency in pair using
	// cashQty field
	...
	public static List<Order> BracketOrder(int parentOrderId, String action, double quantity, double limitPrice,
		...
		// The parent and children orders will need this attribute set to false to
		// prevent accidental executions.
	...
	public static Order TrailingStopLimit(String action, double quantity, double lmtPriceOffset, double trailingAmount,
	...
	public static Order LimitOrderForComboWithLegPrices(String action, double quantity, boolean nonGuaranteed,
			double[] legPrices) {
	...
	public static Order PeggedToBenchmark(String action, double quantity, double startingPrice,
			boolean peggedChangeAmountDecrease, double peggedChangeAmount, double referenceChangeAmount,
			int referenceConId, String referenceExchange, double stockReferencePrice,
	...
	public static Order AttachAdjustableToStopLimit(Order parent, double attachedOrderStopPrice, double triggerPrice,
			double adjustStopPrice, double adjustedStopLimitPrice) {
	...
	public static Order AttachAdjustableToTrail(Order parent, double attachedOrderStopPrice, double triggerPrice,
			double adjustStopPrice, double adjustedTrailAmount, int trailUnit) {
		// ! [adjustable_trail]
		Order order = new Order();
		// Attached order is a conventional STP order
		order.action("BUY".equals(parent.getAction()) ? "SELL" : "BUY");
	...
	public static PriceCondition PriceCondition(int conId, String exchange, double price, boolean isMore,
	...
	public static PercentChangeCondition PercentageChangeCondition(double pctChange, int conId, String exchange,
			boolean isMore, boolean isConjunction) {
		// ! [percentage_condition]
		PercentChangeCondition pctChangeCondition = (PercentChangeCondition) OrderCondition
				.create(OrderConditionType.PercentChange);
	...
	public static VolumeCondition VolumeCondition(int conId, String exchange, boolean isMore, int volume,
			boolean isConjunction) {
		// ! [volume_condition]
